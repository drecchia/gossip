    ...
    value: function whisper(jsonObj) {
      ...
      try {
        ...
        if (!this.safeGetItem(this.localStorageBrowserIdKey)) {
          var _crypto;
          var clientId = (_crypto = crypto) !== null && _crypto !== void 0 && _crypto.randomUUID ? crypto.randomUUID() : "b-".concat(Date.now(), "-").concat(Math.random());
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                ...
                currentDataSize = currentData ? JSON.parse(currentData).length : 0; // Skip if max failures reached and no new data
...
// Constants
_defineProperty(Gossip, "MAX_QUEUE_ITEMS", 2000);
...
_defineProperty(Gossip, "localStorageBrowserIdKey", 'gossipBrowserId');
